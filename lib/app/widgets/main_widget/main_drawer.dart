                            ...
                            child: Row(
                              children: [
                                GestureDetector(
                                  onTap: () async {
                                    await launchUrl(Uri.parse(
                                        "https://www.facebook.com/centerlawzag/"));
                                  },
                                  child: const FaIcon(
                                ...
                                TextButton(
                                    onPressed: () async {
                                      await launchUrl(
                                          Uri.parse("https://www.facebook.com/centerlawzag/"));
                                    },
                                    child: Text(appText.visitFacebook,style: style12Regular().copyWith(color: Colors.white,
                                    fontSize: 9))),
                              ],
                            ),
                          ),
                          ...
                          Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  Text(appText.secondNumberContactUs,
                                      style: style13Bold()
                                          .copyWith(color: Colors.white))
                                ]),
                              ])
